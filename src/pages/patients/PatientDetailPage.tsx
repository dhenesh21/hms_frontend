...
import { patientService, uploadService } from '../../services/api'
import { ArrowLeft, Edit, Calendar, Stethoscope, Phone, MapPin, Heart, Shield, FileText} from 'lucide-react'
    ...
    <div style={{ maxWidth: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, position: 'relative' }}>
          <PhotoUpload
            currentUrl={patient.photo_url}
            name={`${patient.first_name} ${patient.last_name}`}
            size={72}
            shape="square"
            onUpload={(file) => uploadService.patientPhoto(patient.id, file).then(r => r.data)}

...
const ROLES = [
  ...
  { role: 'doctor', label: 'Doctor', color: 'bg-violet-100 text-violet-700', access: ['Patient View', 'OPD Consultation', 'IPD Visit', 'Prescriptions', 'Lab Orders', 'Radiology Orders'] },
...
export default function RolesPage() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold" style={{color:"#1E1B4B"}}>Roles & Access</h1>

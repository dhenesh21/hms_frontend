...
export default function DepartmentsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-bold" style={{color:"#1E1B4B"}}>Departments</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit(d => { toast.success(`${d.name} department added!`); reset() })} className="space-y-3">
            ...
            <button type="submit" className="w-full py-2 bg-violet-600 text-white text-sm rounded-lg hover:bg-violet-700">
              Add Department
            </button>
          </form>
        </div>

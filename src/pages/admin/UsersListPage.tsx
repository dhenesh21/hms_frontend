  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold" style={{color:"#1E1B4B"}}>All Users</h1>
      ...
      <div className="flex gap-3">
        <div className="relative flex-1">
          ...
          <input type="text" placeholder="Search by name, email, employee ID..."
            ...
            className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-violet-500" />
        </div>
        <select value={roleFilter} onChange={e => setRoleFilter(e.target.value)}
          className="px-3 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:ring-2 focus:ring-violet-500 outline-none">
            ...
            {isLoading ? (
              ...
              <tr>
                <td colSpan={8} className="text-center py-14">
                  ...
                  <Link to="/admin/users/new" className="text-violet-600 text-sm hover:underline mt-2 inline-block">

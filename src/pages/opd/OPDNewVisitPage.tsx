      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <DoctorSearchInput inputCls={inputCls} onSelect={(id) => setValue('doctor_id', String(id))} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button type="button" onClick={() => append({ drug_name: '', dosage: '', frequency: '', duration_days: 7, route: 'oral', quantity: 0 })}
              className="flex items-center gap-1 text-xs text-violet-600 hover:text-violet-800 border border-violet-200 px-3 py-1.5 rounded-lg hover:bg-violet-50 transition">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button type="submit" disabled={loading}
            className="flex items-center gap-2 px-5 py-2 text-sm bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-lg hover:from-violet-700 hover:to-indigo-700 disabled:opacity-60 transition shadow-sm shadow-violet-500/30">
            <Save size={16} />

          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
              ...
              <button type="submit" disabled={loading || !selectedRole}
                className="flex items-center gap-2 px-6 py-2 text-sm bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-lg hover:from-violet-700 hover:to-indigo-700 shadow-sm shadow-violet-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition">
                <UserPlus size={16} />
